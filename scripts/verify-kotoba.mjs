...
if (web.kotobaArtifact.requiredCapabilities.length !== 0)
  throw new Error("cron bounded-civil Web graph requested a capability");
if (web.instantiateKotoba().main() !== 42n) throw new Error("cron Web main mismatch");
...
if (wasm.instance.exports.main() !== 42n) throw new Error("cron Wasm main mismatch");

console.log("cron: bounded civil-calendar Web/Wasm conformance passed");
